...
<body id="myPage" data-spy="scroll" data-target=".navbar"
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
       ...
       <ul class="navbar-nav">
			<li class="nav-item"><a class="nav-link" href="aAppointments">Back</a></li>
		</ul>
		<!-- Links -->
    ...
    <div class="container">
			...
			<div class="form-row">
				<div class="col">
					<div class="form-group">
						...
						<input class="form-control" type="text" placeholder="${appointment.pid}" readonly>
					</div>
				</div>
			</div>
			...
			<div class="form-row">
				<div class="col">
					<div class="form-group">
						...
						<input class="form-control" type="text" placeholder="${appointment.aid}" readonly>
					</div>
				</div>
				...
				<div class="col">
					<div class="form-group">
						<label class="control-label">Status: </label> <input
							class="form-control" placeholder="submitted" required="">
					</div>
				</div>
			</div>
		...
		<form action="aAppointments" method="post">
			<div class="form-group">
